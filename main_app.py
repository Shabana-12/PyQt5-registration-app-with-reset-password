...
class Passwordreset(QDialog):
    ...
    def sendmailfunction(self):
        ...
        if result:
            ...
            s.starttls()
            s.login('apexinfotechexcellenceco@gmail.com', '')
            ...
            new, notp = QtWidgets.QInputDialog.getText(self, 'OTP', 'Enter your OTP:')
            ...
            QMessageBox.about(self, 'Resetpassword',
                              "Email-Id is not Registered Please Enter correct email address!!!!")
